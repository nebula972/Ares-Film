...
<nav class="navbar">
    <label class="logo"><a href="index.php" class="navbar-link" ><img class="logo" src="images/Réalisé par ares film BLANC.png" alt="logo ares flim blanc"></a></label>
    <div class="toggle">
    ...
    <ul class="navbar-menu">
        ...
        <li class="navbar-item">
            <a href="formation.php" class="<?php if($page == 'formation.php'){ echo ' active"';}?>" >Formation</a>
        </li>
        <li class="navbar-item">
